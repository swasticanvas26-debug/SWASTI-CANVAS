              ...
              {['Abstract', 'Landscape', 'Portrait', 'Floral', 'Geometric', 'Mixed Media'].map((cat, i) => {
                ...
                return (
                  <a
                    ...
                    className={`bg-gradient-to-br ${colors[i]} text-white rounded-2xl p-4 text-center font-semibold text-sm hover:scale-105 active:scale-95 transition-transform shadow-card`}
                  >
                    {cat}
                  </a>
                )
